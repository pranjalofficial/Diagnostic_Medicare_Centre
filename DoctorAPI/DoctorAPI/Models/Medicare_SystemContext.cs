...
namespace DoctorAPI.Models
{
    public partial class Medicare_SystemContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.tblDoctorMedicare'. Please see the warning messages.
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblMedicalTestHistory>(entity =>
            {
                ...
                entity.HasOne(d => d.MtDrUser)
                    .WithMany(p => p.TblMedicalTestHistory)
                    .HasForeignKey(d => d.MtDrUserId)
                    .HasConstraintName("dr_md_FK_Doctor");
                ...
                entity.HasOne(d => d.MtPtUser)
                    .WithMany(p => p.TblMedicalTestHistory)
                    .HasForeignKey(d => d.MtPtUserId)
                    .HasConstraintName("dr_md_FK_User");
            });
